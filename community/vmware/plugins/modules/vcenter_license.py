...
- ansible.vmware.vmware.vcenter_documentation
...
from ansible_collections.ansible.vmware.plugins.module_utils.vmware import PyVmomi, vmware_argument_spec, find_hostsystem_by_name

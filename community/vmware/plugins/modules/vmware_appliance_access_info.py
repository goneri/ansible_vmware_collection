...
- ansible.vmware.VmwareRestModule.documentation
...
from ansible_collections.ansible.vmware.plugins.module_utils.vmware_httpapi.VmwareRestModule import API, VmwareRestModule

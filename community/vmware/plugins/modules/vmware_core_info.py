...
- ansible.vmware.VmwareRestModule_filters.documentation
...
from ansible_collections.ansible.vmware.plugins.module_utils.vmware_httpapi.VmwareRestModule import VmwareRestModule

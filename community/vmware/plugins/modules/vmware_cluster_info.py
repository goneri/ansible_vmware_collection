...
- ansible.vmware.vmware.documentation
...
from ansible_collections.ansible.vmware.plugins.module_utils.vmware import PyVmomi, vmware_argument_spec, find_datacenter_by_name, find_cluster_by_name
from ansible_collections.ansible.vmware.plugins.module_utils.vmware_rest_client import VmwareRestClient

...
from ansible_collections.ansible.vmware.tests.unit.compat import mock

import ansible_collections.ansible.vmware.plugins.module_utils.vmware as vmware_module_utils
